...
You have access to: `docs/legacy-golden/{seam}/BASELINE_INDEX.md` (manifest), all files under `docs/legacy-golden/{seam}/`, `docs/seams/{seam}/contracts/openapi.yaml`, implemented backend and frontend code.
...
```bash
Agent: discovery
Prompt: "Re-run discovery for {seam} seam. Parity check shows misunderstood requirements: {issue}. Review runtime evidence in docs/legacy-golden/ and update discovery.md."
```
